...
namespace AgencyBanking.Controllers
{
    ...
    public class WalletTransfersController : ControllerBase
    {
        ...
        private decimal? senderBalanceAfterDebit;

        public WalletTransfersController(postgresContext context)
        {
            _context = context;
        }
        ...
        private bool VerifySenderBalance(string smid, decimal? amount)
        {
        ...
        private bool DebitSender(string customerID, decimal? amount)
        {
        ...
        private bool UpdateWalletBalances(Guid transactionId, string Nuban, decimal? amount, string senderID, bool saveBeneficiary)
        {
        ...
        private void UpdateTransationStatus(Guid transactionId, decimal? BalanceAfterDebit, decimal? BalanceAfterCredit, decimal? Balance)
        {
